...
describe("Send Forms",()=>{
    ...
    it("TC1: validate sending the form correctly completed",()=>{
        cy.get(selectors.inputName).type(faker.person.firstName())
        cy.get(selectors.inputLastName).type(faker.person.lastName())
        cy.get(selectors.inputEmail).type(faker.internet.exampleEmail())
        cy.get(selectors.datePicker).click().type("1996-02-08")
